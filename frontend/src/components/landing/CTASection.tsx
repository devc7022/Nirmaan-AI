...
import { ArrowRight, Sparkles, LogIn, HardHat, ShieldCheck, Zap } from 'lucide-react';
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <div className="inline-flex items-center space-x-2 text-xs font-semibold uppercase tracking-wider text-orange-400 bg-orange-500/10 px-4 py-1.5 rounded-full border border-orange-500/30 backdrop-blur-md">
              ...
              <span>Transform Your Construction Site Today</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-zinc-300 max-w-2xl mx-auto leading-relaxed">
              Join leading contractors and site supervisors who save 2+ hours daily, eliminate ghost workers, and automate daily wages with Nirmaan AI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Link
                href="/login"
                className="w-full sm:w-auto px-7 py-4 rounded-xl bg-zinc-950 hover:bg-zinc-800 text-zinc-200 hover:text-white font-semibold text-base border border-zinc-800 flex items-center justify-center space-x-2 transition-colors"
              >
