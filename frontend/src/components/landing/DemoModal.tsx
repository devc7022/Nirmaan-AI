            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white flex items-center gap-2">
                  BumbleBrick AI Interactive Product Tour
          ...
          <div className="p-6 overflow-y-auto space-y-6 flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-xl bg-zinc-950/50 border border-zinc-800 space-y-1.5">
                ...
                <p className="text-xs text-zinc-400">Speak or text in Hindi, English, or Hinglish. BumbleBrick AI parses workers and hours instantly.</p>
              </div>
